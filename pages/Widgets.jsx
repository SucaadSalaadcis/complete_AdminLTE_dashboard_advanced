            ...
            <div class="wrapper">
               ...
               with font-awesome or any other icon font library --> */}
                                ...
                                <li class="nav-item">
                                    ...
                                    <Link to={'/widgets'} class="nav-link active">
                                ...
                                <div class="col-md-3">
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            ...
                                            <div class="card-tools">
                                                <button type="button" class="btn btn-tool" data-card-widget="card-refresh" data-source="Widgets.jsx" data-source-selector="#card-refresh-content">
                                ...
                                <div class="col-md-3">
                                    <div class="card card-success">
                                        <div class="card-header">
                                            ...
                                            <div class="card-tools">
                                                <button type="button" class="btn btn-tool" data-card-widget="card-refresh" data-source="Widgets.jsx" data-source-selector="#card-refresh-content" data-load-on-init="false">
                                                    <i class="fas fa-sync-alt"></i>
                                                </button>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="card card-widget widget-user">
                                        ...
                                        <div class="widget-user-header text-white"
                                            style={{ backgroundImage: "url('../dist/img/photo1.png')", backgroundPosition: "center center" }} >
